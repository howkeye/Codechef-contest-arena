...
function main($flag){
    ...
    'client_secret' => '98e28d4777d1e36f05a5c7652f06fd89',
        ...
        'redirect_uri'=> 'http://localhost:8000/check.php',
    ...
    if(isset($_GET['code'])){
        ...
        echo $oauth_details['access_token']." refresh_token: ";
        echo $oauth_details['refresh_token']."<b> new acesstoken: ";
      ...
      //  $response = make_contest_problem_api_request($config, $oauth_details);
       // $oauth_details = generate_access_token_from_refresh_token($config, $oauth_details);    
             //use this if you want to generate access_token from refresh_token
          //   echo $oauth_details['access_token']." <br> refresh_token: ";
